export const environment = {
  ...
  apiUrl : 'https://api.justice-love-peace.com/api/v1',   //development
  domainUrl:'https://www.justice-love-peace.com',           //development for peackeeper qrcode
  ...
  // tinyUrl : 'https://tinyurl.com/3322sj49',               ///for local testing only
