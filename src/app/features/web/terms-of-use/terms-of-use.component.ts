...
constructor(
  ...
  //     'Terms of Use | Global Justice, Love, and Peace Summit 2025'
  //   );
  ...
  //       name: 'description',
  //       content:
  //         'Review the Terms of Use for the Global Justice, Love, and Peace Summit 2025 in Dubai. Understand the guidelines and policies to ensure a safe and enjoyable experience at the event.',
  //     },
  //     {
  //       name: 'keywords',
  //       content:
  ...
  //     {
  //       property: 'og:url',
  //       content: 'https://www.justice-love-peace.com/terms-of-use',
  //     },
  //     {
  //       property: 'og:type',
  //       content: 'website',
