pipeline {
    ...
    environment {
        ...
        DEPLOY_PATH = "D:\\CI_CD\\\test_angular"
    }

    stages {
        stage('Checkout Code') {
            steps {
                git branch: 'main', credentialsId: 'Github_Cylsys_Credentials', url: 'https://github.com/Saurabh-Cylsys/justice-love-peace.git'
            }
        }
        ...
        stage('Build React App') {
            steps {
                sh 'ng build'  // Linux command for npm run build
            }
        }
